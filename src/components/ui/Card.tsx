...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className={cn(
      bgColor2,
      "border-border-foreground shadow-lg p-4 rounded-lg flex flex-col items-center justify-between",
      "max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl",
      className,
      scale ? "hover:scale-105" : "hover:scale-98",
     ...
     >
      ...
      <div className="flex flex-col flex-grow w-full">
        <h2
         className={cn(
          "text-lg font-bold max-xs:text-base/5 mb-2 truncate w-full",
          textColor,
      ...
      >
        <Button
          label={buttonText}
          className={cn(
            "rounded-lg border text-black text-base font-semibold max-xs:text-small border-border-foreground hover-effect",
