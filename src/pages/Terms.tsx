...
const TermsPage = () => {
  ...
  >
  <Seo
  title="Terms and Conditions | Eventurelly"
  description="Read Eventurelly’s Terms and Conditions to understand the rules and guidelines for using our event platform."
  name="Eventurelly"
  type="website"
/>
