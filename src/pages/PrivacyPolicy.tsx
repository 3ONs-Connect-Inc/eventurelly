...
const PrivacyPolicyPage = () => {
  ...
  return (
    ...
    >
     <Seo
  title="Privacy Policy | Eventurelly"
  description="Read Eventurelly's Privacy Policy to learn how we protect your personal data and ensure your privacy while using our event platform."
  name="Eventurelly"
  type="website"
/>
